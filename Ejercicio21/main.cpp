...
int main()
{
       ...
       if  (int(c) < 91){       //convertimos con el int(c) la letra en numero y miramos si la letra esta en las mayusculas de la tabla ASCII
       ...
       }else if( int(c) > 96){  //convertimos con el int(c) la letra en numero y miramos si la letra esta en las minusculas de la tabla ASCII
